...
namespace GestioLan.API.Migrations
{
    ...
    [Migration("20260309154700_ImageTableLastModified")]
    partial class ImageTableLastModified
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("csharpAPI.Models.Category", b =>
                {
                    ...
                    b.ToTable("category", null, t =>
                        {
                            t.HasCheckConstraint("CK_Category_Bitmask", "(id_category > 0) AND (id_category & (id_category - 1) = 0)");
                        });
                });
